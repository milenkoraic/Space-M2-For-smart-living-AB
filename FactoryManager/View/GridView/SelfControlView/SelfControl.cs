...
{
    public partial class SelfControl : Form
    {
        public SelfControl()
        {
            InitializeComponent();
        ...
        private void SelfControl_Load(object sender, EventArgs e)
        {
            stationer___Akt_och_E_kontrollTableAdapter.Fill(spaceM2Dataset._Stationer___Akt_och_E_kontroll);
