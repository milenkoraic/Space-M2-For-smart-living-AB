...
{
    public partial class Improvement : Form
    {
        public Improvement()
        {
            InitializeComponent();
        ...
        private void Improvement_Load(object sender, EventArgs e)
        {
            fabriksplaneringTableAdapter.Fill(spaceM2Dataset.Fabriksplanering);
