...
{
    public partial class SupplierAddress : Form
    {
        ...
        private void SupplierAddress_Load(object sender, EventArgs e)
        {
            leveransadresserTableAdapter.Fill(this.spaceM2Dataset.Leveransadresser);
