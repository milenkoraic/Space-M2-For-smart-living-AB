...
{
    public partial class ModuleTypeWall : Form
    {
        public ModuleTypeWall()
        {
            InitializeComponent();
        }

        private void ModuleTypeWall_Load(object sender, EventArgs e)
        {
            väggar_per_modultypTableAdapter.Fill(spaceM2Dataset.Väggar_per_modultyp);
