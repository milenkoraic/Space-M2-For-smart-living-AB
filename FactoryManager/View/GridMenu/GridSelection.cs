...
namespace FactoryManager.View.GridMenu
{
    public partial class GridSelection : Form
    {
        ...
        {
            MainForm.SectionIndicator.Text = "";
            this.Close();
        }

        private void HideMenu_MouseEnter(object sender, EventArgs e)
        {
            HideMenu.Size = new Size(32, 32);
            HideMenu.BorderColor = Color.Orange;
        }

        private void HideMenu_MouseLeave(object sender, EventArgs e)
        {
            HideMenu.Size = new Size(30, 30);
            HideMenu.BorderColor = Color.FromArgb(50,170,72);
        }
